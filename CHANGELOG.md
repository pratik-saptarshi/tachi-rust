...
## [4.37.0](https://github.com/pratik-saptarshi/tachi-rust/compare/v4.36.0...v4.37.0) (2026-06-13)
...
* **048:** implement infographic tiered pipeline auto-detection & residual risk ([#49](https://github.com/pratik-saptarshi/tachi-rust/issues/49)) ([e67de32](https://github.com/pratik-saptarshi/tachi-rust/commit/e67de32ba279cf6d9ebf306bccb6266a91d37120))
* **053:** implement risk reduction funnel infographic template ([#56](https://github.com/pratik-saptarshi/tachi-rust/issues/56)) ([48b3c06](https://github.com/pratik-saptarshi/tachi-rust/commit/48b3c06fd61a1a1c81df2564a411e25d9a53255b))
* **054:** implement security assessment PDF booklet ([#58](https://github.com/pratik-saptarshi/tachi-rust/issues/58)) ([053eba9](https://github.com/pratik-saptarshi/tachi-rust/commit/053eba9414abd9c09bcc06ce15f89871da8cb1cd))
* **060:** implement professional PDF security assessment report ([#60](https://github.com/pratik-saptarshi/tachi-rust/issues/60)) ([#61](https://github.com/pratik-saptarshi/tachi-rust/issues/61)) ([c3cc8cf](https://github.com/pratik-saptarshi/tachi-rust/commit/c3cc8cfde59074048197aa38d238e99e019e6bbf))
* **066:** install script and version tagging ([#85](https://github.com/pratik-saptarshi/tachi-rust/issues/85)) ([9ed2a7f](https://github.com/pratik-saptarshi/tachi-rust/commit/9ed2a7fe01975ccd22dd0791fc49eb9d320ea06f))
* **067:** add deterministic report data extraction script ([#68](https://github.com/pratik-saptarshi/tachi-rust/issues/68)) ([7dc8b1c](https://github.com/pratik-saptarshi/tachi-rust/commit/7dc8b1cbd861a45e42da23313b182056bd76c2b7))
* **071:** add deterministic infographic data extraction ([#72](https://github.com/pratik-saptarshi/tachi-rust/issues/72)) ([61df3d4](https://github.com/pratik-saptarshi/tachi-rust/commit/61df3d47a04d8b795ed5981f30ffb90b99f1d583))
* **074:** baseline-aware pipeline with coverage checklists and delta tracking ([#79](https://github.com/pratik-saptarshi/tachi-rust/issues/79)) ([856f35e](https://github.com/pratik-saptarshi/tachi-rust/commit/856f35e0b0b7a054a85a21e06fa0ba9538bf2438))
* **075:** tachi agent best practices and domain knowledge skills ([#76](https://github.com/pratik-saptarshi/tachi-rust/issues/76)) ([cdf91e7](https://github.com/pratik-saptarshi/tachi-rust/commit/cdf91e76ed33482262ca6d01803efe2767564bad))
* **078:** agent context optimization — reduce agent prompt sizes by 40-60% ([#81](https://github.com/pratik-saptarshi/tachi-rust/issues/81)) ([46fc7e6](https://github.com/pratik-saptarshi/tachi-rust/commit/46fc7e6966d7d7d21354647b0a97e66a524394f2))
...
* **084:** add MAESTRO layer mapping to threat model pipeline ([#92](https://github.com/pratik-saptarshi/tachi-rust/issues/92)) ([ac2ca0e](https://github.com/pratik-saptarshi/tachi-rust/commit/ac2ca0e03ec6f2cda85b45ebb2829486099e0985))
* **086:** automated release tagging via GitHub Actions ([#86](https://github.com/pratik-saptarshi/tachi-rust/issues/86)) ([#88](https://github.com/pratik-saptarshi/tachi-rust/issues/88)) ([f1ad4ef](https://github.com/pratik-saptarshi/tachi-rust/commit/f1ad4efef2df517f8739cfa6598dd4b5f1ac4132))
* **091:** add MAESTRO infographic templates and PDF report section ([#96](https://github.com/pratik-saptarshi/tachi-rust/issues/96)) ([f0f0e9a](https://github.com/pratik-saptarshi/tachi-rust/commit/f0f0e9aae9eeaae6ecda726954dc3ffac95408f7))
* **104:** add downstream baseline propagation for threat model output ([#107](https://github.com/pratik-saptarshi/tachi-rust/issues/107)) ([4589231](https://github.com/pratik-saptarshi/tachi-rust/commit/4589231e9fd7fdcd38a5e5abf848e1c3e80abacf))
* **112:** add attack path pages to PDF security report ([#115](https://github.com/pratik-saptarshi/tachi-rust/issues/115)) ([febfa28](https://github.com/pratik-saptarshi/tachi-rust/commit/febfa28a6dcd92d9551dcb1ea7864ed2ad674bdb))
...
* **145:** Canonical MAESTRO Worked Example ([#175](https://github.com/pratik-saptarshi/tachi-rust/issues/175)) ([b04cf03](https://github.com/pratik-saptarshi/tachi-rust/commit/b04cf03e51c14c4ce7253d592dd9e0db22781d3e))
...
* **cli:** add infographic output file support ([52c9d5a](https://github.com/pratik-saptarshi/tachi-rust/commit/52c9d5a45ecc2d3b6ad02d7e94e3c1d1db6b3e31))
* **cli:** add report-data output flag ([8e026e2](https://github.com/pratik-saptarshi/tachi-rust/commit/8e026e24ac028818b1e854b9fa21fda745e264b0))
* **cli:** add risk scores sarif command ([09391ca](https://github.com/pratik-saptarshi/tachi-rust/commit/09391caf383d228a1e84e69071f804df81e382a7))
* **cli:** add Rust report-data command ([f47d638](https://github.com/pratik-saptarshi/tachi-rust/commit/f47d63838b4667cacab05c43164db366373bbed9))
* **cli:** add threats sarif command ([d250fe5](https://github.com/pratik-saptarshi/tachi-rust/commit/d250fe58b9a97a394c5ab0808aa6cdc42a2a63b2))
* **core:** add attack-chain parser slice ([04a3b9c](https://github.com/pratik-saptarshi/tachi-rust/commit/04a3b9c39fdbee7d5669bf6aad29eb55ae915465))
* **core:** add coverage attestation report data ([d05dbbc](https://github.com/pratik-saptarshi/tachi-rust/commit/d05dbbcc0bf874cceec1138c18dc92f07bcab395))
* **core:** add coverage family catalog ([18f2996](https://github.com/pratik-saptarshi/tachi-rust/commit/18f29966d20f4e93f32d11b0e8488d0a4becab90))
* **core:** add maestro component layer mapping slice ([0fcc91c](https://github.com/pratik-saptarshi/tachi-rust/commit/0fcc91c2806b23aae59af742e79344dbb533120e))
* **core:** add maestro finding and heatmap slices ([8d1f1e4](https://github.com/pratik-saptarshi/tachi-rust/commit/8d1f1e46ad5475310f99bcd474ef1c56060f15f3))
* **core:** add maestro layer summary slice ([97683d4](https://github.com/pratik-saptarshi/tachi-rust/commit/97683d41c1b5f09de1be50d3bed27ae7e58ba2ae))
* **core:** add native MAESTRO infographic data support ([b351644](https://github.com/pratik-saptarshi/tachi-rust/commit/b3516444c76452db1bc4545a4d15047f7efc511a))
* **core:** add Rust attack-chain Mermaid generation ([6a1a798](https://github.com/pratik-saptarshi/tachi-rust/commit/6a1a79821de4cf76356d079b2d719edabf4d6228))
* **core:** add Rust taxonomy catalogs ([71d15f6](https://github.com/pratik-saptarshi/tachi-rust/commit/71d15f668da00a5bfdba57527f448422780fcabb))
* **core:** group maestro findings by layer ([661e95d](https://github.com/pratik-saptarshi/tachi-rust/commit/661e95d98ef92303828b41476c00d721cf900fc0))
* **core:** merge infographic helper slice from worktree ([8233126](https://github.com/pratik-saptarshi/tachi-rust/commit/82331261345b8f614c02df608dbd9b4452b76d40))
* **core:** merge rust migration feature branch ([7c51b80](https://github.com/pratik-saptarshi/tachi-rust/commit/7c51b80e15590fb1dfdc0eaa3de05f20394b670d))
* **core:** normalize maestro layer aliases ([4117b60](https://github.com/pratik-saptarshi/tachi-rust/commit/4117b60389714ef9668f03bed831636b16e20310))
* **core:** port compensating controls parser slice ([6ba5825](https://github.com/pratik-saptarshi/tachi-rust/commit/6ba5825091857b057a673f7ae2fef411941be525))
* **core:** port executive architecture infographic parity ([d93b3fe](https://github.com/pratik-saptarshi/tachi-rust/commit/d93b3fe115a2a794bd171d24f2bb5a9658aada5d))
* **core:** port infographic helper slice to Rust ([c742bfa](https://github.com/pratik-saptarshi/tachi-rust/commit/c742bfae3e5aedcffd196d892157820188a3882b))
* **core:** port infographic prompt scaffold slice ([412c922](https://github.com/pratik-saptarshi/tachi-rust/commit/412c92259eb062e0ac18e1098f51b2419bb71199))
* **core:** port risk scores parser slice ([062b231](https://github.com/pratik-saptarshi/tachi-rust/commit/062b231e146aba711de2ed726f08f18ab9966f13))
* **core:** port threat sarif emitter slice ([3dc180d](https://github.com/pratik-saptarshi/tachi-rust/commit/3dc180df7bb50e02b917927d90d52d19ef16fe8a))
* **desktop:** add thin src-tauri shell scaffold ([02d7f17](https://github.com/pratik-saptarshi/tachi-rust/commit/02d7f17d9323b28b16927ecbc22c295078a754d0))
* **parsers:** port asset tag parsing to rust ([872e029](https://github.com/pratik-saptarshi/tachi-rust/commit/872e029de4b0c1d5486658ef9e7ee02ef1716a2c))
* **report-data:** emit project metadata from rust ([6ea45f6](https://github.com/pratik-saptarshi/tachi-rust/commit/6ea45f6f19a1907719c3e1524bfa81ef7972c133))
* **shell:** add init timing trace hook ([26bf8f1](https://github.com/pratik-saptarshi/tachi-rust/commit/26bf8f10d459d6015fcf9ff62a4e7f9037b2be8a))
* **shell:** add init trace summary ([cf92f12](https://github.com/pratik-saptarshi/tachi-rust/commit/cf92f12520b40ecaa411fd2c6d8030e9ab9dec15))
* **shell:** add millisecond init trace summaries ([4cbe635](https://github.com/pratik-saptarshi/tachi-rust/commit/4cbe6351ba3a3d2965b90ee7be7e7edd86260180))
* **shell:** add same-clone init benchmark matrix ([3d404a2](https://github.com/pratik-saptarshi/tachi-rust/commit/3d404a2b2ecf8186f174bcd7e9af8b3edb40a221))
* **shell:** add same-clone init benchmark samples ([91990b9](https://github.com/pratik-saptarshi/tachi-rust/commit/91990b9b879fc0242b9800e610a592366686920d))
* **shell:** add shared Rust control-plane bridge ([4dfa8fd](https://github.com/pratik-saptarshi/tachi-rust/commit/4dfa8fd5aedad92ea35f8d0f4ff431ae4d04c7f8))
* **shell:** reuse manifest-backed init paths ([da0b574](https://github.com/pratik-saptarshi/tachi-rust/commit/da0b5744bdea2cb1548c4275c6755b1e4aef119a))
* **shell:** route infographic data through desktop bridge ([12dbc58](https://github.com/pratik-saptarshi/tachi-rust/commit/12dbc58a65d0d4e2c682af0dc7e6c9d2137b34e8))
* **shell:** simplify init trace summary fields ([4772e78](https://github.com/pratik-saptarshi/tachi-rust/commit/4772e78c0e329c53062433e2de30bfb3a3dad49f))
* **shell:** surface slowest init phase in trace summary ([d978e4c](https://github.com/pratik-saptarshi/tachi-rust/commit/d978e4c8873b578085557a60f690bac02777f4f1))
* **shell:** trace init stack discovery and precommit ([e060935](https://github.com/pratik-saptarshi/tachi-rust/commit/e06093596417e7117d52face4c7665d23043c430))
...
* **074:** baseline auto-detection and downstream command context limits ([#102](https://github.com/pratik-saptarshi/tachi-rust/issues/102)) ([5aeb10b](https://github.com/pratik-saptarshi/tachi-rust/commit/5aeb10bf24ef9e002bed5d73b76c4989456bca23))
* **074:** enforce mandatory Phase 2 discovery even with baseline ([#105](https://github.com/pratik-saptarshi/tachi-rust/issues/105)) ([3174674](https://github.com/pratik-saptarshi/tachi-rust/commit/31746746ebabda9367831ec87eaf0773a5815d40))
* **086:** add workflow_dispatch trigger to release-please ([c0231b6](https://github.com/pratik-saptarshi/tachi-rust/commit/c0231b653428204538525bf42950250a243e0022))
* **086:** auto-bump version examples in README and install.sh ([dcc65b1](https://github.com/pratik-saptarshi/tachi-rust/commit/dcc65b1a86250b5e73828b2e0fef70ac029c8d6d))
* **086:** fetch tags before reporting installed version ([07f6873](https://github.com/pratik-saptarshi/tachi-rust/commit/07f687333133f886847af74ddfeba48e2a3ab6ae))
* **086:** remove release-type input so config file is respected ([a07d0e2](https://github.com/pratik-saptarshi/tachi-rust/commit/a07d0e25c45c7003b5f70323435325936e2093c0))
* **091,104:** MAESTRO heading fallback, fresh attack trees, MAESTRO in all/PDF ([#113](https://github.com/pratik-saptarshi/tachi-rust/issues/113)) ([cefa1b1](https://github.com/pratik-saptarshi/tachi-rust/commit/cefa1b10218aa2e1bdae8076dd1e08ed963ffd2f))
* **104:** skip RESOLVED findings when generating attack trees ([#110](https://github.com/pratik-saptarshi/tachi-rust/issues/110)) ([7bd1779](https://github.com/pratik-saptarshi/tachi-rust/commit/7bd17795d3bcb2e3745b375fc2f57507ea0f9f86))
...
* **shell:** export tauri bridge module ([dbebfc3](https://github.com/pratik-saptarshi/tachi-rust/commit/dbebfc376afbb87eb91ba82b5ee5d35deaf61724))
* **shell:** match init trace summary ms fields ([9345f2c](https://github.com/pratik-saptarshi/tachi-rust/commit/9345f2c7c2206fc860d89f3abf75ad2a7b6d1f0d))
* update install instructions and refine security report templates ([112b496](https://github.com/pratik-saptarshi/tachi-rust/commit/112b496cad21add2128c42e35c837761bee9a2f1))


### Performance

* **core:** reuse report-data threats content ([7958b91](https://github.com/pratik-saptarshi/tachi-rust/commit/7958b91ff9eb32ff5047bae462ab32b781ee952c))
* **shell:** bound constitution template substitution ([69422b1](https://github.com/pratik-saptarshi/tachi-rust/commit/69422b121783e987ea0861f19efb80250edc8076))
* **shell:** keep constitution template on tracked substitution path ([08c9346](https://github.com/pratik-saptarshi/tachi-rust/commit/08c9346f992990ee4db7f95363ae8f6153c1759e))
* **shell:** narrow init substitution to manifest files ([3140146](https://github.com/pratik-saptarshi/tachi-rust/commit/3140146e6159243488f60f1258bb3d656ec18e62))
* **shell:** preserve template and constitution personalization ([05a95e0](https://github.com/pratik-saptarshi/tachi-rust/commit/05a95e08929d05a9077dbc4aaa28906a7ec678fb))
* **shell:** scope init substitution to manifest files ([0622cba](https://github.com/pratik-saptarshi/tachi-rust/commit/0622cba8cd3684dfc1bc2fa15c5fe7a666f6b1a4))
* **shell:** scope init substitution to tracked files ([ecf5b18](https://github.com/pratik-saptarshi/tachi-rust/commit/ecf5b18e3f1754bdeb59aa50463a664a10a77671))
