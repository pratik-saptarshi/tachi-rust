...
payload="$(jq -c '
  . as $root
  | {schema_version:1,audit_sink:"audit.jsonl",promotion_status:"passed",promotion_note:"final reviewed E2E-COV-010.2 fake-tool replay; no live model or network",model:$root.model,seed:$root.seed,network_policy:"deny",network_used:false,max_iterations:$root.max_iterations,timeout_seconds:$root.timeout_seconds,
