...
- [ ] Repository branch protection is enabled and required checks are verified; current `gh api .../branches/main/protection` returns HTTP 404, so the publish gate remains fail-closed.
