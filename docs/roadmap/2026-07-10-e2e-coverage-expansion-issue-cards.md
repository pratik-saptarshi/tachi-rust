...
- **Current baseline after uplift slices 1-6**: 77.27% branch coverage, 1,408 total branches / 320 missed, measured with explicit nightly `RUSTC`/`RUSTDOC` paths. Slice 6 covers AISVS validation edges and attack-chain parser/rendering fallbacks.
