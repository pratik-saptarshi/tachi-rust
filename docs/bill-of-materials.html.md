...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 90.22% regions and 90.56% lines. Nightly 1.99.0 records 81.82% branch coverage (1,408 total / 256 missed), below the requested 85% target; E2E-COV-007 remains open. |
