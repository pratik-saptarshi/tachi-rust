...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 85.03% regions and 85.45% lines. Nightly 1.99.0 records 69.39% branch coverage (1,408 total / 431 missed), below the requested 85% target; E2E-COV-007 remains open. |
