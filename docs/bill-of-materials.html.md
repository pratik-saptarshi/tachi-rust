...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 87.83% regions and 88.40% lines. Nightly 1.99.0 records 73.44% branch coverage (1,408 total / 374 missed), below the requested 85% target; E2E-COV-007 remains open. |
