...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 88.77% regions and 89.33% lines. Nightly 1.99.0 records 75.07% branch coverage (1,408 total / 351 missed), below the requested 85% target; E2E-COV-007 remains open. |
