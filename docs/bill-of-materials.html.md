...
| Deterministic agentic replay | `E2E-COV-010.2` | Partial harness: `scripts/agentic-replay.sh`, `tests/fixtures/agentic/replay.json`, and `crates/tachi-core/tests/agentic_replay_contract.rs` enforce offline fixture shape, governed allowlist, explicit approval/denial/timeout/cancel/circuit transitions, deterministic correlation, an independent 0600 JSONL audit sink, and network denial. Promotion remains skipped pending scripted fake-tool execution review. |
