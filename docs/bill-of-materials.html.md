...
| Coverage gate | `make llvm-cov` | Latest local run on 2026-07-10 passed the configured 85% line threshold at 84.77% regions and 85.25% lines; branch coverage is not emitted by the current LLVM report. |
