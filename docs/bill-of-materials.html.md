...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 89.74% regions and 90.14% lines. Nightly 1.99.0 records 78.27% branch coverage (1,408 total / 306 missed), below the requested 85% target; E2E-COV-007 remains open. |
