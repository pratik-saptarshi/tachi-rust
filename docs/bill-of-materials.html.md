...
| CI gate | GitHub Actions run status | Historical post-merge `2bf68bb` and documentation merge `f34f5a5` evidence remains labeled; current PR #33 feature commit `7a739b1` has 20/20 reported checks passed, including CodeQL, supply-chain, gitleaks, clippy, rustfmt, route, and workspace suites. PR #33 remains OPEN/BLOCKED under protected policy with auto-merge enabled; this is not a claim that main has merged it. |
