...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 89.07% regions and 89.65% lines. Nightly 1.99.0 records 77.27% branch coverage (1,408 total / 320 missed), below the requested 85% target; E2E-COV-007 remains open. |
