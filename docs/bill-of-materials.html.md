...
| CI gate | GitHub Actions run status | Release, security, lint, docs, workspace, init, and dynamic CodeQL workflows for post-merge `2bf68bb` are green; runs are recorded in the readiness checklist and integration log. |
