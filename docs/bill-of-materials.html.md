...
| Coverage gate | `make llvm-cov` | Latest local run on 2026-07-10 passed the configured 85% line threshold at 85.03% regions and 85.45% lines; branch coverage is not emitted by the current LLVM report. |
