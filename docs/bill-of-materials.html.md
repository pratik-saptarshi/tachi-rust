...
| RT-CI timing evidence | `make rt-ci-latency-evidence`, `docs/tachi-rust-ci-baseline.md` | Current mainline sample: workspace 40-run median 67s (2–361s), route-observe 5-run median 16s (12–16s), queue medians 0s. PR-specific repeated samples and branch-protection evidence remain required; the collector fails closed while `main` is unprotected (HTTP 404). |
