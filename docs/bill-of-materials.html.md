...
| CI gate | GitHub Actions run status | Historical post-merge `2bf68bb` and documentation merge `f34f5a5` evidence remains labeled; current PR #33 feature commit `4c0cb98` has passing completed checks while CodeQL rust/javascript-typescript analysis and several workspace jobs remain pending. PR #33 remains OPEN/BLOCKED under protected policy with auto-merge enabled; this is not a claim that main has merged it. |
