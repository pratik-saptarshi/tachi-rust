...
| Coverage gate | `make llvm-cov`; nightly branch command with explicit `RUSTC`/`RUSTDOC` paths | Stable gate passes at 88.04% regions and 88.62% lines. Nightly 1.99.0 records 74.43% branch coverage (1,408 total / 360 missed), below the requested 85% target; E2E-COV-007 remains open. |
