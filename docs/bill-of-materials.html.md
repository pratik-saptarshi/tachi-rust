...
| RT-CI timing evidence | `make rt-ci-latency-evidence`, `docs/tachi-rust-ci-baseline.md`, `docs/tachi-rust-ci-execution-plan.md` | Mainline sample: workspace 40-run median 71s (2–361s), route-observe 11-run median 14s (12–17s), queue medians 0s. Representative pull-request sample: workspace 22-run median 85s (79–101s), route-observe 23-run median 14s (11–17s), queue medians 0s. Branch protection and required-check evidence are verified; the canonical RT-CI baseline and execution plan now carry the same closeout sample and no longer describe it as a blocker. |
