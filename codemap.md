...
| E2E | Critical init, CLI analysis-to-artifact, desktop host command, and MCP stdio flows are explicitly classified by `crates/tachi-core/tests/coverage_audit.rs`; the `E2E-COV*` roadmap expands coverage to the remaining user-facing boundaries. |
