...
| Coverage | Fresh host-assisted publish-gate stages pass. Current `make llvm-cov` reports 93.24% lines / 92.60% regions, with the configured 85% line threshold passing. The governed nightly 1.99.0 lane exits 0 at 85.15625% branch coverage (1,408 branches / 210 missed) after deterministic CLI, desktop, MCP stdio, and shell-bridge failure-edge coverage; E2E-COV-007 meets its branch target. The terminal local-full cleanup receipt is `20260713T045400Z-79992`; the historical closeout runner `20260712T195832Z-73032` and its older 90.56% / 90.22% snapshot remain separately labeled. The current dated audit refresh reports 119 active modules, 101 Rust integration modules, 13 Rust unit modules, 1 Rust smoke module, 4 Rust E2E modules, and 0 support/regression modules. Live remote refs are verified at main `61ba9ee` and feature `4c0cb98`; PR #33 head `9c8a4f7` has 20 terminal checks passed and 0 failures but remains protected `OPEN/BLOCKED` because the Copilot review attempt hit quota exhaustion. |
