...
| Coverage | `make llvm-cov` is the stable release-quality gate: 90.22% regions / 90.56% lines, with the configured 85% line threshold passing. Nightly 1.99.0 now records 78.98% branch coverage (1,408 branches / 296 missed), below the requested 85% target; E2E-COV-007 remains open for uplift and governance. The current audit has 112 active modules, 94 Rust integration modules, 13 Rust unit modules, 1 Rust smoke module, 4 Rust E2E modules, and 0 support/regression modules. |
